      ...
      'sections'       => array(
        'wc_general_section' => array(
          ...
          'fields'      => array(
            ...
            'site_favicon' => array(
              'title'             => __( 'Favicon', 'wen-corporate' ),
              'type'              => 'image',
              'sanitize_callback' => 'esc_url_raw',
            ),
            'site_web_clip_icon' => array(
              'title'             => __( 'Web Clip Icon', 'wen-corporate' ),
              'type'              => 'image',
              'sanitize_callback' => 'esc_url_raw',
            ),
            'color_scheme' => array(
...
// Hide favicon if WP >= 4.3
if ( ! version_compare( $GLOBALS['wp_version'], '4.3', '<' ) ) {
	if ( isset( $our_settings['panels']['wen_corporate_theme_options_panel']['sections']['wc_general_section']['fields']['site_favicon'] ) ) {
		unset($our_settings['panels']['wen_corporate_theme_options_panel']['sections']['wc_general_section']['fields']['site_favicon']);
	}
	if ( isset( $our_settings['panels']['wen_corporate_theme_options_panel']['sections']['wc_general_section']['fields']['site_web_clip_icon'] ) ) {
		unset($our_settings['panels']['wen_corporate_theme_options_panel']['sections']['wc_general_section']['fields']['site_web_clip_icon']);
	}
}
